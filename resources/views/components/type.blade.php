 ...
 <section class="py-20 bg-gray-50">
     <div class="container mx-auto px-6">
         ...
         <div class="text-center">
             <h2 class="text-3xl sm:text-4xl font-bold text-(--color-secondary) tracking-tight">
         ...
         <div class="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-16">
             ...
             <div class="text-center">
                 ...
                 <p class="mt-2 text-base text-gray-600">
                     Fileswift menjadi pilihan utama bagi individu dan profesional dalam menangani dokumen digital
                     secara
                     efisien dan aman.
                 </p>
             </div>
             ...
             <div class="text-center">
                 <div class="flex justify-center items-center mb-3">
                     <svg class="h-20 w-auto" fill="#0f4c75" height="200px" width="200px" version="1.1" id="Layer_1"
                         xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                 ...
                 <p class="mt-2 text-base text-gray-600">
                     Fileswift mendukung konversi dokumen, gambar, audio, hingga video dalam berbagai format umum
                     seperti
