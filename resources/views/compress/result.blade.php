        ...
        <div class="bg-[var(--color-primary)] rounded-xl p-4">
            <div
                ...
                <header class="text-center mb-8">
                    <h2 class="text-3xl font-bold mb-4 text-white">Kompress File Berhasil! 🎉</h2>
                ...
                <div class="flex items-center gap-4 mb-6 bg-white/10 rounded-xl p-4 w-full max-w-md">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="text-white/80 text-sm mt-1">Ukuran sebelum: <span
                                class="font-semibold">{{ number_format($beforeSize / 1024, 2) }} KB</span></div>
                        <div class="text-white/80 text-sm">Ukuran sesudah: <span
                                class="font-semibold">{{ number_format($afterSize / 1024, 2) }} KB</span></div>
                        <div class="text-white/80 text-sm">Penghematan: <span
                                class="font-semibold">{{ $beforeSize > 0 ? number_format(100 - ($afterSize / $beforeSize) * 100, 1) : 0 }}%</span>
                        </div>
                    </div>
                </div>

                <a href="{{ $downloadUrl }}?name={{ urlencode($finalName) }}"
                ...
                <div class="mt-8">
                    <a href="{{ route('compress.index') }}" class="text-white/80 hover:text-white text-lg transition">
